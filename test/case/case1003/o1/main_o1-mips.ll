...
entry:
  ...
  tail call void @f_printf(i32 signext %sub6)
...
entry:
  ...
  tail call void @f_printf(i32 signext %mul12)
  %add13 = add nsw i32 %call, -672
  tail call void @f_printf(i32 signext %add13)
...
entry:
  ...
  tail call void @f_printf(i32 signext %mul16)
...
entry:
  ...
  %call6 = tail call i32 @func2(i32 signext %call)
  %call7 = tail call i32 @func3(i32 signext undef, i32 signext undef)
  %call8 = tail call i32 @func4(i32 signext %call, i32 signext %call1, i32 signext %call2)
  ret i32 0
}
