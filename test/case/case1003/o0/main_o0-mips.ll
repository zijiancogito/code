...
entry:
  ...
  call void @f_printf(i32 signext %14)
...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func2(i32 signext %p0) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %var0 = alloca i32, align 4
  %var1 = alloca i32, align 4
  ...
  %13 = load i32, i32* %var3, align 4
  call void @f_printf(i32 signext %13)
...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func3(i32 signext %p0, i32 signext %p1) #0 {
entry:
  %p0.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind optnone
define dso_local i32 @func4(i32 signext %p0, i32 signext %p1, i32 signext %p2) #0 {
entry:
  %p0.addr = alloca i32, align 4
  %p1.addr = alloca i32, align 4
  ...
  call void @f_printf(i32 signext %21)
...
entry:
  ...
  %0 = load i32, i32* %var0, align 4
  %call6 = call i32 @func2(i32 signext %0)
  %1 = load i32, i32* %var0, align 4
  %2 = load i32, i32* %var1, align 4
  %call7 = call i32 @func3(i32 signext %1, i32 signext %2)
  %3 = load i32, i32* %var0, align 4
  %4 = load i32, i32* %var1, align 4
  %5 = load i32, i32* %var2, align 4
  %call8 = call i32 @func4(i32 signext %3, i32 signext %4, i32 signext %5)
  ret i32 0
}
